  ...
  return (
    ...
    <div className={`${styles.paddingX} absolute insert-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
      <div className="flex flex-col justify-center items-center mt-5">
        ...
        <div className="w-1 sm:h-80 h-40 cobalt-gradient" />
      </div>
      
      <div>
        <h1 className={`${styles.heroHeadText} text-black`}>Hi, I'm <span className="text-[#5271ff]">Jennifer</span></h1>
        <p className={`${styles.heroSubText} mt-2 text-black-100`}>
          Sytems Design Engineering @UWaterloo 
        </p>
        <p className={`${styles.sectionSubText} mt-2 text-black-100`}>
          (Spin the chicken!)
        </p>
      </div>
    </div>

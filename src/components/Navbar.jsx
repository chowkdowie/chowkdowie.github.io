...
//import { logoblack } from '../../../jy-logo-zip-file/logoblack.svg';
//import { logowhite } from '../../../jy-logo-zip-file/logowhite.svg';
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[19px] font-bold cursor-pointer flex">Jennifer Yi &nbsp; <span className="sm:block hidden">| Portfolio</span></p>
        </Link>
